...
9. **Stack LLM agnóstico de proveedor — completo** (2026-05-26). Cuatro crates nuevos para abrir transformaciones generadas por LLM dentro de pluma sin acoplar a ningún proveedor concreto.
   ...
   - **Pendiente**: Notebook gioser sobre estos primitives (celdas como `NarrativeAtom`s + ejecutores como kernels) y vista LLM-aware en el editor (botones "traducir/resumir/etc." sobre cualquier cuerpo madre).
