...
- [~] Prezi / vista espacial — **2 BUGS CORREGIDOS 2026-06-27:** (1) el modo no viajaba al Cuerpo enlazado (colapsaba a Hyprland — mismo fix que el cubo); (2) aun con el modo correcto, Win+Tab en sesión enlazada hacía el slide «sencillo» porque el compositor sólo abría la vista espacial en embebido. Ahora en Prezi+enlazado Win+Tab se reenvía a la app que pinta su overview (como Super+e). Navegación dentro del overview: dígitos 1-9/click eligen, Esc cierra. Falta verlo en metal. Pendiente aparte: rotación viva + mapa Prezi editable en wawa-panel.
