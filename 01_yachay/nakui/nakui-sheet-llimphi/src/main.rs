...
fn cycle_col(col: u32, range: &CellRange, dir: i32) -> u32 {
...
fn pivot_key(wb: &Workbook, cr: CellRef) -> String {
    match wb.value(cr) {
...
fn compute_pivot(wb: &Workbook, p: &PivotState) -> PivotResult {
...
/// columna (A, B, …).
fn pivot_col_label(wb: &Workbook, p: &PivotState, col: u32) -> String {
    if p.header_row {
