...
pub use commands::{
    ...
    cmd_show, cmd_status, cmd_sync, cmd_verify_root, cmd_watch, DiffLine, DiffResult,
    IngestResult, LogEntry, PruneStats, RepoStatus, RetireResult, ShowResult, VerifyResult,
};
