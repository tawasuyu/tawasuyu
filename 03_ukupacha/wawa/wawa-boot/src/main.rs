...
fn sembrar_grafo() -> Result<(Vec<u8>, usize), String> {
    ...
    // `marco: None` => el kernel siembra el marco por defecto en el primer
    // arranque y lo reancla; una propuesta en caliente (sys_marco_proponer) lo
    // mueve sin pasar por aquí.
