//! `chaka-runtime` — el soporte de ejecución de los programas COBOL
//! transpilados.
//!
//! Lo que `chaka-codegen` emite no es Rust autónomo: es Rust que
...
//!
//! La aritmética decimal exacta la aporta `chaka-bcd`, cuyos tipos
