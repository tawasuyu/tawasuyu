//! Tests de WebAudio, WebCodecs, MediaRecorder, MSE, EME, MediaCapabilities, Canvas2D, WebGL, FontLoading, Geometry, CSSOM, Scheduler, URLPattern, WebGPU, WebXR, BackgroundFetch, ImageCapture, CompressionStreams, WindowManagement, LocalFonts, WebOTP, PiP, DocumentPiP, CloseWatcher, ShapeDetection, EditContext, VirtualKeyboard.
    use super::*;
