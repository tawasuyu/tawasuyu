...
- **Bloqueado por:** nada. Siguiente: font-weight real cuando llimphi-text lo abra, fetch async / cancelable, selectores `> + ~` y pseudoclases, persistencia de la cache entre sesiones.
