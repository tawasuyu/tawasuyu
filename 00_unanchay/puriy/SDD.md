...
- **Bloqueado por:** nada. Siguiente: font-weight real cuando llimphi-text lo abra, fetch async / cancelable, selectores compuestos (`a b`, `a:hover`), cache de imágenes entre recargas.
