...
- **Bloqueado por:** nada. Siguiente: font-weight real cuando llimphi-text lo abra, fetch async / cancelable, pseudoclases (`:hover`, `:first-child`), selectores de atributo (`[href]`), persistencia de la cache entre sesiones.
