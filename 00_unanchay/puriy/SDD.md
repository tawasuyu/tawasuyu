...
- **Bloqueado por:** nada. Siguiente: line wrapping de inlines (texto se amontona en el top del párrafo), font-weight real cuando llimphi-text lo abra, fetch async / cancelable, gestures back/fwd touch.
