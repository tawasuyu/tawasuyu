...
pub use mirada_protocol::{
    BodyEvent, BrainCommand, Decorations, OutputId, RecordCodec, RecordSpec, TitleAlign,
    TitlebarAction, TitlebarButtonStyle, TitlebarEdge, TitlebarItem, TitlebarLayout, WindowEffects,
    WindowPlacement,
};
