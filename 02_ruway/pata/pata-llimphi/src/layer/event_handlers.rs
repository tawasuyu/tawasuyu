...
impl LayerShellHandler for LayerApp {
    fn closed(&mut self, _: &Connection, _: &QueueHandle<Self>, layer: &LayerSurface) {
        ...
        // Todas las surfaces (incluido el drawer del sidebar) son permanentes: si el
        // compositor cierra alguna (en arje-DRM mirada lo hace al resetear el output),
        // salimos y el wrapper de respawn nos relanza.
        self.exit = true;
    }
