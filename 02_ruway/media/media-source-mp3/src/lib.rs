//! media-source-mp3 — decoder MP3 (vía symphonia) como [`AudioSource`].
//!
//! Misma forma que [`media_source_wav::WavSource`]: decodea el
...
//!
//! Implementa [`media_core::Seekable`] sobre el cursor de
