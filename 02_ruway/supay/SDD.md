...
- **Caveat.** Sólo bloquean las paredes one-sided; un two-sided con la puerta **bajada** (vano cerrado) deja pasar el sonido — necesitaría las alturas de ambos sectores del linedef (fase futura). Tampoco hay difracción ni reflexión por la pared, sólo el pasa-bajos directo. **A validar al correr** (sin device ni WAD en dev): que un imp tras una pared suene apagado y se "abra" al cruzar el vano.
