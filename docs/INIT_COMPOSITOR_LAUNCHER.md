...
- **2026-05-27 (wawa Fase 58)**: launcher gráfico vueltas 1–3 — `Alt+P` abre overlay modal con teclado + ratón modales, búsqueda por texto en vivo (substring case-insensitive con refiltrado por keystroke), Escape/Backspace soportados sin Alt. Cola `PARTOS_POR_INDICE` paralela a la legacy de rotación. Mirror atómico `LAUNCHER_ABIERTO` para que el IRQ del teclado decida sin tomar locks.
