...
use tawasuyu_geom::ChacanaSpec;
use tawasuyu_palette::{cosmos, Rgb};
use tawasuyu_physics::{SpringDamper1, SpringDamper2};
use tawasuyu_shaders::{
...
pub mod tips {
    use tawasuyu_palette::{elements, Rgb};
...
impl Renderer {
    ...
    pub fn render(&mut self, time_ms: f64) {
        ...
        upload_rgb(
            ...
            tawasuyu_palette::elements::AIRE,
        );
        upload_rgb(
            gl,
            self.chacana_prog.u("u_fuego_color"),
            tawasuyu_palette::elements::FUEGO,
        );
        upload_rgb(
            gl,
            self.chacana_prog.u("u_tierra_color"),
            tawasuyu_palette::elements::TIERRA,
        );
        upload_rgb(
            gl,
            self.chacana_prog.u("u_agua_color"),
            tawasuyu_palette::elements::AGUA,
        );
