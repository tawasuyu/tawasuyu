//! Panel de control del escritorio tawasuyu-web.
//!
...
//!
//! Persistencia: `localStorage` con prefijo `tawasuyu.`. Si no hay
...
//! `CustomEvent("tawasuyu:rebind")` sobre `document`, con
...
const STORE_VARIANT: &str = "tawasuyu.theme.variant";
const STORE_ACCENT: &str = "tawasuyu.theme.accent";
const STORE_DENSITY: &str = "tawasuyu.theme.density";
const STORE_LANG: &str = "tawasuyu.lang";
const STORE_TIMEFMT: &str = "tawasuyu.timefmt";
const STORE_MODS_HIDDEN: &str = "tawasuyu.mods.hidden";
...
impl Panel {
    ...
    pub fn mount(&self) -> Result<(), JsValue> {
        ...
        let ev = CustomEvent::new_with_event_init_dict("tawasuyu:rebind", &init)?;
...
impl State {
    fn load(storage: Option<&Storage>) -> Self {
        ...
        Self {
            ...
            accent: get(STORE_ACCENT, "tawasuyu"),
...
fn apply_theme(doc: &Document, state: &State) -> Result<(), JsValue> {
    ...
    let accent = if state.accent == "tawasuyu" { "" } else { &state.accent };
    if accent.is_empty() {
...
fn t(key: &str, lang: &str) -> &'static str {
    // No traducimos nombres propios (tawasuyu, llimphi, supay, …).
    ...
    match key {
        ...
        "sec.about.hint"       => triple!("Información del escritorio tawasuyu.",
                                          "About the tawasuyu desktop.",
                                          "tawasuyu munay kawsayniq willay."),
        ...
        "ap.tawasuyu"   => triple!("tawasuyu",    "tawasuyu", "tawasuyu"),
        ...
        // about
        "ab.blurb" => triple!(
            "Escritorio web de tawasuyu — monorepo de cuatro cuadrantes: unanchay (percibir), yachay (conocer), ruway (hacer) y ukupacha (raíz).",
            "tawasuyu web desktop — four-quadrant monorepo: unanchay (perceive), yachay (know), ruway (do), and ukupacha (root).",
            "tawasuyu munay kawsay — tawa kuti hatun llamk'ay: unanchay (riqsiy), yachay (yachay), ruway (ruway), ukupacha (saphi)."
        ),
  ...
  <div class="panel-group">
    ...
    <div class="panel-row">
      ...
      <div class="panel-segmented" data-group="{store_accent}">
        <button class="panel-seg" data-value="tawasuyu"  ><span class="seg-swatch" style="background:#6E8CDC"></span>tawasuyu</button>
...
fn render_apps() -> String {
    ...
    let cards: &[(&str, &str, &str, &str, &str, &str)] = &[
        ...
        ("pluma · editor",  "00 unanchay", "unanchay",
         ...
         "/web/tawasuyu-web/md/aire.md", "pluma"),
        ("khipu",           "00 unanchay", "unanchay",
         "Telar de hebras y nodos — gravedad simbólica.",
         "/web/tawasuyu-web/md/sombra.md", "khipu"),
        ...
        ("nakui · explorer","01 yachay",  "yachay",
         ...
         "/web/tawasuyu-web/md/cosmos.md", "nakui"),
        ...
        ("wawa-explorer",   "03 ukupacha","ukupacha",
         ...
         "/web/tawasuyu-web/md/tierra.md", "wawa"),
        ("agora",           "03 ukupacha","ukupacha",
         "Mercado y plaza pública del sistema.",
         "/web/tawasuyu-web/md/agua.md", "agora"),
